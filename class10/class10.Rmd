...
There are some funkey things in this dataset that we will ignore for our analysis. This includes the ID and Diagnosis columns and the funny last X column (col 33).
...
Lookes like we need to set scale = TRUE!!
...
This does not look good! Let's try and combine the results of PCA with clustering to see if PCA improves or degrades the performance of hierarchical clustering.
...
Use the 'predict()' function with our previor PCA model and new data...
...
Now draw the PCA model again and add our new data:
